    ...
    <div className="screen">
      <header className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <a href="https://finaura.vercel.app" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', height: '32px', marginRight: 8, background: 'linear-gradient(135deg, #3B5BDB, #40C057)', borderRadius: '8px', padding: '0 12px', textDecoration: 'none', opacity: 0.9, transition: 'opacity 0.2s ease' }} onMouseOver={e => e.currentTarget.style.opacity = "1"} onMouseOut={e => e.currentTarget.style.opacity = "0.9"}>
