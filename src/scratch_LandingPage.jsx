...
import {
  ...
  ChevronRight, Star, ArrowRight, CheckCircle2, QrCode, HardDrive
} from "lucide-react";
...
const FEATURES = [
  ...
  },
  {
    ...
    title: "Pay & Record",
    desc: "Scan UPI QR codes, securely record payments in your vault, and keep track of intents instantly.",
  },
  {
    icon: HardDrive,
    color: "#14b8a6",
    bg: "rgba(20,184,166,0.12)",
    title: "Daily Backup Reminders",
    desc: "Never lose data again. Get smart daily reminders to export your encrypted vault.",
  },
  {
    icon: Bell,
    color: "#f43f5e",
      ...
      <div className="lp-scroll">
        ...
        <section className="lp-hero">
          ...
          <p className="lp-hero-sub">
            Track cards, banks, cashback, QR payments &amp; expenses — all encrypted on your device. No cloud, no subscriptions, no compromise.
          </p>
          ...
          <div className="lp-steps-list">
            ...
            <div className="lp-step-card" style={{ "--step-color": "#6366f1", "--step-bg": "rgba(99,102,241,0.12)" }}>
              ...
              <div className="lp-step-body">
                ...
                <p className="lp-step-desc">Manually add expenses, scan UPI QR codes, or paste bank SMS into QuickSync AI.</p>
              </div>
            </div>
